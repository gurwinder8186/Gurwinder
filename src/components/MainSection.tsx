  ...
  return (
    <section className="flex flex-col items-center text-center bg-gray-100 py-6 md:py-6 scroll-smooth">
      <div className="max-w-4xl w-full px-6 flex flex-col items-center space-y-8">
        <div className="flex flex-col items-center space-y-8 md:flex-row md:items-center md:justify-between md:space-y-0">
          <div className="text-center md:text-left max-w-lg">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-800 mb-4 md:mb-8">
              Gurwinder Singh
            </h2>
            <h3 className="text-xl font-medium text-gray-600 mb-4 md:mb-8 relative flex items-center justify-center md:justify-start">
              <span className="w-16 md:w-24 border-t border-gray-700 mr-3"></span>
              Full Stack Developer
            </h3>
            <p className="text-gray-700 leading-relaxed mb-4 md:mb-8">
              I'm skilled in React, TypeScript, HTML5, and more, passionate about creating innovative solutions.
            </p>
            <a href="#contact" className="flex justify-center md:justify-start">
              <button className="px-6 py-3 bg-gray-500 text-white rounded-xl hover:bg-black hover:text-white hover:font-semibold flex items-center justify-center mb-4 md:mb-8 transition">
                Say Hello{' '}
                <span className="ml-2">
                  <Send size={16} />
                </span>
